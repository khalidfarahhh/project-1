...
<ul>
<li>The typical time complexity of a hashtable is o to the 1. </li>
</ul>
...
<span class="c1"># Only 3 of the 5 values are there</span>

<span class="c1"># Why do you think Sets are in the same tech talk as Hashmaps/Hashtables?</span>
<span class="c1"># Maybe also an example of a hash table</span>
</pre></div>
...
<span class="c1"># Dictionaries, lists, strings</span>
...
<span class="c1"># Make producer array into a set instead</span>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">for</span> <span class="n">k</span><span class="p">,</span><span class="n">v</span> <span class="ow">in</span> <span class="n">lover_album</span><span class="o">.</span><span class="n">items</span><span class="p">():</span> <span class="c1"># iterate using a for loop for key and value</span>
    <span class="nb">print</span><span class="p">(</span><span class="nb">str</span><span class="p">(</span><span class="n">k</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;: &quot;</span><span class="p">,</span> <span class="n">end</span><span class="o">=</span><span class="s2">&quot;&quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="p">(</span><span class="nb">type</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="nb">list</span> <span class="ow">or</span> <span class="nb">type</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="nb">set</span><span class="p">):</span>
        <span class="k">for</span> <span class="n">v2</span> <span class="ow">in</span> <span class="n">v</span><span class="p">:</span>
            <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2"> </span><span class="se">\t</span><span class="s2"> &quot;</span> <span class="o">+</span> <span class="n">v2</span><span class="p">)</span>
    <span class="k">elif</span> <span class="p">(</span><span class="nb">type</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="o">==</span> <span class="nb">dict</span><span class="p">):</span>
        <span class="k">for</span> <span class="n">k2</span><span class="p">,</span><span class="n">v2</span> <span class="ow">in</span> <span class="n">v</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2"> </span><span class="se">\t</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">k2</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;: &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">v2</span><span class="p">))</span>
    <span class="k">else</span><span class="p">:</span> 
        <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2"> </span><span class="se">\t</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">v</span><span class="p">))</span>
...
<span class="c1"># search tracks </span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">my_turn_album</span> <span class="o">=</span> <span class="p">{</span>
    <span class="s2">&quot;title&quot;</span><span class="p">:</span> <span class="s2">&quot;My Turn&quot;</span><span class="p">,</span>
    <span class="s2">&quot;artist&quot;</span><span class="p">:</span> <span class="s2">&quot;Lil Baby&quot;</span><span class="p">,</span>
    <span class="s2">&quot;genre&quot;</span><span class="p">:</span> <span class="s2">&quot;Trap&quot;</span><span class="p">,</span>
    <span class="s2">&quot;songs&quot;</span><span class="p">:</span> <span class="p">[</span>
        <span class="s2">&quot;Get Ugly&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Heatin Up&quot;</span><span class="p">,</span>
        <span class="s2">&quot;How&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Grace&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Woah&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Live Off My Closet&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Same Thing&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Emotionally Scarred&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Commercial&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Forever&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Can&#39;t Explain&quot;</span><span class="p">,</span>
        <span class="s2">&quot;No Sucker&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Sum 2 Prove&quot;</span><span class="p">,</span>
        <span class="s2">&quot;We Should&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Catch The Sun&quot;</span><span class="p">,</span>
        <span class="s2">&quot;Consistent&quot;</span>
    <span class="p">]</span>
<span class="p">}</span>

<span class="c1"># Access the dictionary keys and values</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Album title: &quot;</span> <span class="o">+</span> <span class="n">my_turn_album</span><span class="p">[</span><span class="s2">&quot;title&quot;</span><span class="p">])</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Artist: &quot;</span> <span class="o">+</span> <span class="n">my_turn_album</span><span class="p">[</span><span class="s2">&quot;artist&quot;</span><span class="p">])</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Genre: &quot;</span> <span class="o">+</span> <span class="n">my_turn_album</span><span class="p">[</span><span class="s2">&quot;genre&quot;</span><span class="p">])</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Songs: &quot;</span> <span class="o">+</span> <span class="s2">&quot;, &quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">my_turn_album</span><span class="p">[</span><span class="s2">&quot;songs&quot;</span><span class="p">]))</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Album title: My Turn
Artist: Lil Baby
Genre: Trap
Songs: Get Ugly, Heatin Up, How, Grace, Woah, Live Off My Closet, Same Thing, Emotionally Scarred, Commercial, Forever, Can&#39;t Explain, No Sucker, Sum 2 Prove, We Should, Catch The Sun, Consistent
</pre>
</div>
</div>
